...
public final class HeaderBinding implements ViewBinding {
  ...
  private HeaderBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView head) {
  ...
  public static HeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.head;
      ImageView head = rootView.findViewById(id);
      if (head == null) {
        break missingId;
      }

      return new HeaderBinding((ConstraintLayout) rootView, head);
    }
